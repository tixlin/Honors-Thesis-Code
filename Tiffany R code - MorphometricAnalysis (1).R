...
LM.sLM.Array=LM.sLM.Array*0.035  #Scaling the voxels by voxel size
...
define.sliders(c(84,125:134)) #LM.5 doesn't repeat anymore, is position 84; LM.7 is position 134, ST.1 is position 125
...
define.sliders(c(112,145:157)) #LM.6 doesn't repeat anymore, it is position 112; LM.8 is position 157, IT.1 is position 145
...
# rbind all of the sliders ------------------------------------------------


#rbind all the products of define.sliders into one; named this "final.sliders"
final.sliders=rbind(define.sliders(1:14),define.sliders(15:28),define.sliders(29:48),define.sliders(49:68),define.sliders(c(14,69:84)),define.sliders(c(28,85:100)),define.sliders(c(48,101:112)),define.sliders(c(68,113:124)),define.sliders(c(84,125:134)),define.sliders(c(100,135:144)),define.sliders(c(112,145:157)),define.sliders(c(124,158:170)))

# procrustes superimposition  ---------------------------------------------


#Do the Procrustes Analysis now; call this "zygo.procrustes.superimposition"
#file.name=gpagen(A=array.name, curves=final.sliders (all the r-binded define.sliders)).... is the "LM.sLM.Array" the new array name? in the original file, it was "finalarray.outputfile"....

zygo.procrustes.superimposition=gpagen(LM.sLM.Array, curves=final.sliders, surfaces=NULL)

#Try identifying outliers
plotOutliers(zygo.procrustes.superimposition$coords)
plotRefToTarget(zygo.procrustes.superimposition$consensus,zygo.procrustes.superimposition$coords[,,"dd0389"],method="vector",radius=0.001)

#create groups
color.f=factor(c(rep("blue",4),rep("red",4)))

geno.f=
 
  plotOutliers(zygo.procrustes.superimposition$coords,groups=geno.f) 
